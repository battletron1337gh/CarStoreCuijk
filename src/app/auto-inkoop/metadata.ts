...
export const metadata: Metadata = {
  ...
  description: 'Auto inkoop Cuijk - Wij kopen voornamelijk 1ste eigenaar autos en alle merken. Gratis taxatie, direct geld. Ook 1e eigenaar autos met schade. 175 reviews, 5 sterren. Bel nu!',
  ...
  openGraph: {
    ...
    description: 'Wij kopen alle merken auto\'s. Gratis taxatie, direct geld. 175 reviews, 5 sterren.',
    type: 'website',
    locale: 'nl_NL',
